...
export function calculateComponentOutage(
  ...
  return {
    ...
    allowableNoAdjacent: component.allowable_no_adjacent ?? false,
    isZeroTolerance: component.is_zero_tolerance ?? false,
    isExceeded,
    isApproaching,
    ...
    requiredActions: {
      notam: component.requires_notam ?? false,
      notifyCE: component.requires_ce_notification ?? false,
      systemShutoff: component.requires_system_shutoff ?? false,
      notifyTerps: component.requires_terps_notification ?? false,
      obstructionNotamAttrs: component.requires_obstruction_notam_attrs ?? false,
    },
...
export function calculateSystemHealth(
  ...
  return {
    ...
    isPrecision: system.is_precision ?? false,
    status,
