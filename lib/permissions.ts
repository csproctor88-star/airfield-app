...
export const PERM = {
  ...
  FPR_VIEW:                             'fpr:view',
  FPR_WRITE:                            'fpr:write',
  FPR_MANAGE_CHECKLIST:                 'fpr:manage_checklist',
  DRIVING_CHECKS_VIEW:                  'driving_checks:view',
  DRIVING_CHECKS_WRITE:                 'driving_checks:write',
  DRIVING_CHECKS_MANAGE_ITEMS:          'driving_checks:manage_items',
