...
export const DEMO_DISCREPANCIES = [
  {
    ...
    work_order_number: 'WO-2026-0038', sla_deadline: new Date(Date.now() - 2 * 86400000).toISOString(),
  ...
  },
  {
    ...
    work_order_number: 'WO-2026-0037', sla_deadline: new Date(Date.now() + 20 * 3600000).toISOString(),
  ...
  },
  {
    ...
    work_order_number: null, sla_deadline: new Date(Date.now() - 2 * 86400000).toISOString(),
  ...
  },
  {
    ...
    work_order_number: null, sla_deadline: new Date(Date.now() + 12 * 86400000).toISOString(),
  ...
  },
  {
    ...
    work_order_number: null, sla_deadline: null,
