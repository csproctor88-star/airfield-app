...
export const MODULES: ModuleRef[] = [
  {
    ...
    screenshots: [
      { src: '/training/airfield-status_1.png', caption: 'Airfield Status landing — live weather, runway labels, NAVAID grid, and advisories on one screen.' },
      { src: '/training/airfield-status_2.png', caption: 'Click any NAVAID to open the status dialog — pick green / yellow / red and add notes for shift handoff context.' },
      { src: '/training/airfield-status_3.png', caption: 'AFM Out-of-Office toggle posts a custom away message visible to every shift.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/dashboard_1.png', caption: 'Shift-handoff KPI tiles — inspection state, last check, open discrepancies.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/activity_1.png', caption: 'Day-grouped timeline with relative anchors and per-group entry counts.' },
      { src: '/training/activity_2.png', caption: 'Period chips and a single search bar narrow the timeline by date or any field.' },
      { src: '/training/activity_3.png', caption: 'Manual-entry templates pre-fill the category so report rollups stay clean.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/recent-activity_1.png', caption: 'Per-user cards reorganize the same audit data by actor for shift-handoff oversight.' },
      { src: '/training/recent-activity_2.png', caption: 'Period and entity filters narrow to the prior shift\'s window or a specific module.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/qrc_1.png', caption: '25 starter checklists from AFMAN 91-203, with a review-overdue indicator per tile.' },
      { src: '/training/qrc_2.png', caption: 'Each step captures the acknowledger and Zulu timestamp automatically.' },
      { src: '/training/qrc_3.png', caption: 'After-Action PDF bundles every step + acknowledgement for the post-event debrief.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/scn_1.png', caption: 'Per-agency badges with auto-stamped time when you toggle them.' },
      { src: '/training/scn_2.png', caption: 'Monthly PDF export — your AFMAN evidence package in one click.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/shift-checklist_1.png', caption: 'Three-state toggles per task; progress counts completed and N/A as resolved.' },
      { src: '/training/shift-checklist_2.png', caption: 'Frequency tags color-code Daily, Weekly, and Monthly items at a glance.' },
      { src: '/training/shift-checklist_3.png', caption: 'History tab keeps every past shift checklist with closer name and Zulu time.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/checks_1.png', caption: 'Seven check types — Daily, Lighting, FOD, Weather, Construction, Heavy Aircraft, Other.' },
      { src: '/training/checks_2.png', caption: 'Log discrepancies inline as you walk the airfield; photos attach per discrepancy.' },
      { src: '/training/checks_3.png', caption: 'Drafts auto-save to Supabase + localStorage so you can resume from any device.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/inspections_1.png', caption: 'Launchpad for every inspection cadence at your base.' },
      { src: '/training/inspections_2.png', caption: 'Issues log directly to Discrepancies with auto-routing to CES shops.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/acsi_1.png', caption: 'One section at a time — Pass / Fail / N/A per item with optional remarks and photos.' },
      { src: '/training/acsi_2.png', caption: 'Per-member signature toggle for full team sign-off on the official record.' },
      { src: '/training/acsi_3.png', caption: 'Long-running drafts surface as \'Continue ACSI Draft\' so multi-day runs resume cleanly.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/daily-reviews_1.png', caption: 'Per-day rows with colored rails — green when fully certified, amber when your slot is pending.' },
      { src: '/training/daily-reviews_2.png', caption: 'Sign modal carries name + rank + Zulu timestamp + optional notes per slot.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/discrepancies_1.png', caption: 'KPI tiles quick-filter by status owner; status pills show current lifecycle state.' },
      { src: '/training/discrepancies_2.png', caption: 'Notes history captures every status change and resolution comment.' },
      { src: '/training/discrepancies_3.png', caption: 'Map view plots filtered discrepancies on the airfield diagram for cluster spotting.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/ces_1.png', caption: 'Shop tabs filter to your shop; KPI badges break out work-state counts.' },
      { src: '/training/ces_2.png', caption: 'Status modal limited to CES-relevant transitions; notes feed the discrepancy history.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/ppr_1.png', caption: 'Triage queue with KPI pills for awaiting-review counts and per-agency pending coordination.' },
      { src: '/training/ppr_2.png', caption: 'Coordination log tracks per-agency replies through Review › Coordination › Approval.' },
      { src: '/training/ppr_3.png', caption: 'Public QR-coded request form at /<icao>/ppr-request — no login required.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/wildlife_1.png', caption: 'Day-grouped timeline mixes sightings (green) and strikes (red) with dispersal context.' },
      { src: '/training/wildlife_2.png', caption: 'Heatmap aggregates strike density on the airfield map for hotspot identification.' },
      { src: '/training/wildlife_3.png', caption: 'Analytics breaks out trends by species, time of day, and dispersal effectiveness.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/contractors_1.png', caption: 'Active personnel with credential color-coding — red when within 30 days of expiry.' },
      { src: '/training/contractors_2.png', caption: 'Templates speed up recurring contractors so repeat visits are one-click.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/parking_1.png', caption: 'To-scale silhouettes from a 200+ airframe library; clearance updates live as you drag.' },
      { src: '/training/parking_2.png', caption: 'Aircraft tab groups placed silhouettes by type for quick selection and bulk edits.' },
      { src: '/training/parking_3.png', caption: 'Clearance tab lists every violation and warning with feet-clearance numbers and UFC cite.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/obstructions_1.png', caption: 'Click any point to compute distance, altitude, and surface penetration per UFC 3-260-01.' },
      { src: '/training/obstructions_2.png', caption: 'Multi-point mode evaluates lines or areas at every vertex and flags worst penetration.' },
      { src: '/training/obstructions_3.png', caption: 'History keeps every past evaluation for the next review cycle.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/infrastructure_1.png', caption: 'Map view of every NAVAID with system-level rollup in the Lighting Status panel.' },
      { src: '/training/infrastructure_2.png', caption: 'Reporting a fixture inop re-evaluates the system tier per DAFMAN A3.1 and creates a discrepancy.' },
      { src: '/training/infrastructure_3.png', caption: 'Edit Mode lets admins drag fixtures, bulk-shift, or place new bars from the toolbar.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/waivers_1.png', caption: 'KPI tiles for Permanent / Temporary / Expiring / Overdue Review filter the list with one click.' },
      { src: '/training/waivers_2.png', caption: 'Six classifications cover permanent, temporary, construction, event, extension, and amendment.' },
      { src: '/training/waivers_3.png', caption: 'Annual review queue flags waivers due for recertification each year.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/aircraft_1.png', caption: '200+ airframes — search by type or manufacturer; sort by dimensions or MTOW.' },
      { src: '/training/aircraft_2.png', caption: 'Per-airframe specs with ACN/PCN calculator for pavement-bearing comparisons.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/regulations_1.png', caption: '70+ regulations across DAFMAN, UFC, AFMAN, AF Form — searchable by content or title.' },
      { src: '/training/regulations_2.png', caption: 'In-app PDF viewer opens any reg without a download.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/notams_1.png', caption: 'Expiring-within-24h NOTAMs glow red so they\'re unmissable on shift handoff.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/reports_1.png', caption: 'Five canned reports plus a 30-day analytics dashboard across every module.' },
      { src: '/training/reports_2.png', caption: 'PDFs generate client-side — no airfield data leaves your installation.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/settings_1.png', caption: 'Profile, theme, and operating initials (used in audit-trail signatures).' },
      { src: '/training/settings_2.png', caption: 'Offline section caches regulations and base-area map tiles for no-signal use.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/users_1.png', caption: 'Status states — pending, active, deactivated — with role badges from the permission matrix.' },
      { src: '/training/users_2.png', caption: 'Invitations send a branded email via Resend and land the user in pending status.' },
    ],
    faq: [],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/training/feedback_1.png', caption: 'Stats cards aggregate submissions and average rating with semantic color rails per row.' },
    ],
    faq: [],
