...
### Dual-mode (USAF and FAA Part 139)
...
### Multi-installation and base switching
...
### Role-based access control and per-base data isolation
...
### Daily shift-review electronic sign-off
...
### Offline operation (Progressive Web App)
...
### One-click PDF report generation and branded email distribution
...
### Public and kiosk forms (no login required)
...
#### ACSI (Annual Compliance Inspection)
...
### Automated NAVAID / lighting outage detection
...
### Obstruction evaluation against imaginary surfaces
...
### Aircraft parking clearance analysis
...
### Runway condition / field-condition assessment (civilian)
...
### Protective rate-limiting on public endpoints
