...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      ['DAF Form 1098 (with or without YYYY)', '"DAF Form 1098" alone is imported as the current year; "DAF Form 1098 2026" (or any 4-digit year) is imported under that year. Multiple year sheets are supported.'],
      ...
      ['DAF Form 623A', 'Narrative training log — Date / Type / Trainee / Trainer / NAMT / AFM comments. (Older templates use the bare name "623A"; both work.)'],
