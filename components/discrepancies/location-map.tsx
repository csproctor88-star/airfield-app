...
const DiscrepancyLocationMap = forwardRef<LocationMapHandle, Props>(
  function DiscrepancyLocationMap({ onPointSelected, selectedLat, selectedLng }, ref) {
    ...
    useImperativeHandle(ref, () => ({
      captureScreenshot: async () => {
        const m = map.current
        if (!m) return null
        // Wait a frame for the marker to render fully
...
export default DiscrepancyLocationMap
