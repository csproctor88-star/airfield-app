...
var S = {
  ...
  globalItem: { display: "flex", padding: "10px 0", borderBottom: "1px solid #1E293B", background: "none", border: "none", borderBottom: "1px solid #1E293B", color: "inherit", cursor: "pointer", textAlign: "left", width: "100%", fontFamily: "inherit" },
