...
export default function TrainingPage() {
  ...
  const handleDownloadModulePdf = async () => {
    ...
    try {
      ...
      const { doc, filename } = generateModuleReferencePdf(moduleData)
      doc.save(filename)
  ...
  const handleDownloadSetupPdf = async () => {
    ...
    try {
      ...
      const steps = SETUP_STEPS.map(s => ({
        ...
        instructions: s.instructions, tips: s.tips,
      }))
      const { doc, filename } = generateBaseSetupPdf(steps)
      doc.save(filename)
