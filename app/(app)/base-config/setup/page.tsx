...
import { DrivingCheckItemsTab } from '@/components/base-setup/driving-check-items-tab'
      ...
      <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start', marginBottom: 12 }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            ...
            {step.key === 'drivingcheckitems' && <DrivingCheckItemsTab installationId={installationId} markSaved={markSaved} />}
