                    ...
                    >
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: 4,
                          border: '1px solid var(--color-border)',
                          background: item.item_type === 'bwc' ? 'var(--color-warning)' : item.item_type === 'rsc' ? 'color-mix(in srgb, var(--color-blue) 12%, transparent)' : item.item_type === 'rcr' ? 'color-mix(in srgb, var(--color-violet) 12%, transparent)' : 'var(--color-bg-inset)',
