...
export default function AgingDiscrepanciesPage() {
  ...
  const [selectedPdfColumns, setSelectedPdfColumns] = useState<string[]>([...BASIC_COLUMNS, 'type', 'shop', 'days_open', 'last_update'])
  ...
  return (
    <div className="page-container">
      ...
      {/* PDF Column Picker (photos/comments disabled for aging reports) */}
      <PdfTemplateSelector
