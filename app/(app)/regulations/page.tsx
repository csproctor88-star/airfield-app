...
// Dynamically import the PDF viewer to avoid SSR issues (react-pdf needs browser APIs)
...
export default function RegulationsPage() {
  ...
  // PDF viewer state — only pass serializable props across the dynamic boundary
  const [viewingReg, setViewingReg] = useState<RegulationEntry | null>(null)

  const closeViewer = useCallback(() => setViewingReg(null), [])
  ...
  // PDF viewer overlay — all PDF logic lives in the viewer component
  if (viewingReg) {
    return (
      <RegulationPDFViewer
