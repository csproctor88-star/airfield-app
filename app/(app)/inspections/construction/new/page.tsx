...
import { ArrowLeft, HardHat, Users, MessageSquare, Camera, X, CheckCircle2 } from 'lucide-react'
...
export default function ConstructionInspectionPage() {
  ...
  const handleFile = async () => {
    ...
    const { data, error } = await createInspection({
      inspection_type: 'construction_meeting',
    ...
    <div className="page-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <div style={{ width: '100%', maxWidth: 600 }}>
        ...
        <div style={{
          ...
          borderBottom: '1px solid color-mix(in srgb, var(--color-amber) 35%, transparent)',
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <HardHat size={16} color="var(--color-amber)" />
            <div style={{
        ...
        <div className="card" style={{ marginBottom: 12, padding: 14, borderRadius: 12 }}>
          ...
          <ExpandableTextarea
            className="input-dark"
            rows={6}
            placeholder="Enter pre/post construction inspection comments..."
            value={comment}
