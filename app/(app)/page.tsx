  ...
  return (
    <div className="page-container">
      ...
      {navaids.length === 0 ? (
        ...
        return (
          <>
          <div className="actions-row" style={{ flexWrap: 'wrap', marginBottom: allFlagged.length > 0 ? 8 : 16 }}>
            {endGroups.filter(group => group.items.length > 0).map(group => (
              <div key={group.designator} className="card" style={{ padding: '10px 14px 4px', flex: '1 1 140px', minWidth: 140 }}>
            ...
            {otherNavaids.length > 0 && (
              <div className="card" style={{ padding: '10px 14px 4px', flex: '1 1 140px', minWidth: 140 }}>
