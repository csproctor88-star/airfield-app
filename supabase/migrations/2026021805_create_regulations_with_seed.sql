...
INSERT INTO regulations (reg_id, title, description, publication_date, url, source_section, source_volume, category, pub_type, is_core, is_cross_ref, is_scrubbed, tags) VALUES
('14 CFR Part 139', 'Certification of Airports', 'FAA standards for airport safety, firefighting, and emergency planning at joint-use airfields.', '12 Feb 2026', NULL, 'II', 'Vol. 2', 'safety', 'CFR', false, false, false, ARRAY['Part 139', 'airport certification', 'ARFF', 'emergency planning', 'joint-use']),
...
INSERT INTO regulations (reg_id, title, description, publication_date, url, source_section, source_volume, category, pub_type, is_core, is_cross_ref, is_scrubbed, tags) VALUES
('FAA Order JO 7210.3', 'Facility Operation and Administration', 'Administration of air traffic control facilities.', '22 Jan 2026', 'https://www.faa.gov/documentLibrary/media/Order/7210.3DD_Bsc_w_Chg_1_2_and_3_dtd_9-5-24.pdf', 'III', 'Vol. 3', 'atc', 'FAA', false, false, false, ARRAY['ATC facility', 'administration', 'JO 7210.3']),
('FAA Order JO 7110.10', 'Flight Services', 'Flight service personnel briefings and radio contact.', '22 Jan 2026', 'https://www.faa.gov/documentLibrary/media/Order/7110.10EE_Bsc_w_Chg_1_and_2_dtd_1-22-26_Final.pdf', 'III', 'Vol. 3', 'atc', 'FAA', false, false, false, ARRAY['flight services', 'briefings', 'radio contact', 'JO 7110.10']),
('FAA Order JO 1900.47', 'ATC Operational Readiness and Contingency Planning', 'ATC facility management during emergencies or disruptions.', '30 Apr 2024', 'https://www.faa.gov/documentLibrary/media/Order/Final_Order_JO_1900.47G_05_01_23.pdf', 'III', 'Vol. 3', 'emergency', 'FAA', false, false, false, ARRAY['ATC contingency', 'operational readiness', 'emergency', 'JO 1900.47']),
...
('ICAO Annex 14', 'Aerodromes - Vol. I', 'International aerodrome design and operations standards.', 'Jul 2022', NULL, 'IV', 'UFC 3-260-01', 'airfield_design', 'ICAO', false, false, false, ARRAY['ICAO', 'aerodrome', 'international standards', 'Annex 14']);
...
('14 CFR Part 77', 'Safe, Efficient Use, and Preservation of the Navigable Airspace', 'FAA obstruction evaluation standards; defines imaginary surfaces for airfield planning.', 'Current Ed.', NULL, 'VI-B', NULL, 'airfield_design', 'CFR', false, true, false, ARRAY['Part 77', 'obstruction evaluation', 'imaginary surfaces', 'navigable airspace']),
('14 CFR Part 121', 'Operating Requirements: Domestic, Flag, and Supplemental Operations', 'Air carrier operational standards referenced by 14 CFR Part 139 for airport certification.', 'Current Ed.', NULL, 'VI-B', NULL, 'safety', 'CFR', false, true, false, ARRAY['Part 121', 'air carrier', 'operations', 'certification']),
('14 CFR Part 380', 'Public Charters', 'Public charter operations regulations referenced in 14 CFR Part 139 applicability.', 'Current Ed.', NULL, 'VI-B', NULL, 'international', 'CFR', false, true, false, ARRAY['Part 380', 'public charters', 'charter operations']),
('14 CFR Part 5', 'Safety Management Systems', 'FAA SMS requirements; referenced in 14 CFR 139 Subpart E for airport-tenant SMS data sharing.', 'Current Ed.', NULL, 'VI-B', NULL, 'safety', 'CFR', false, true, false, ARRAY['SMS', 'safety management systems', 'Part 5', 'data sharing']),
('14 CFR Part 11', 'General Rulemaking Procedures', 'Procedures for petitioning FAA for exemptions from Part 139 requirements.', 'Current Ed.', NULL, 'VI-B', NULL, 'publications', 'CFR', false, true, false, ARRAY['Part 11', 'rulemaking', 'exemptions', 'petitions']),
('49 CFR 830', 'NTSB Notification and Reporting', 'Defines aircraft accidents/incidents; Part 139 references 830.2 for hazard definitions.', 'Current Ed.', NULL, 'VI-B', NULL, 'safety', 'CFR', false, true, false, ARRAY['NTSB', 'accident reporting', 'incident notification', 'hazard definitions']);
...
INSERT INTO regulations (reg_id, title, description, publication_date, url, source_section, source_volume, category, pub_type, is_core, is_cross_ref, is_scrubbed, tags) VALUES
('FAA Order JO 7610.14', 'Non-Sensitive Procedures for Special Operations', 'Contains the MOA between DOT/FAA and US Army-Navy-Air Force (Appendix 4-2). Governs ATC evaluation authority and AO-CV guiding regulations. Referenced in Vol 1 Att 7 (A7.1.1.1-A7.1.1.2).', 'Current Ed.', 'https://www.faa.gov/documentLibrary/media/Order/7610.14_NSMIL_Bsc_w_Chg_1_2_and_3_dtd_2-20-25.pdf', 'VII-B', 'Vol. 1', 'atc', 'FAA', false, false, true, ARRAY['special operations', 'MOA', 'ATC evaluation', 'AO-CV', 'JO 7610.14']),
('FAAO 8200.1D', 'United States Flight Inspection Manual', 'Flight inspection procedures for RAWS equipment and NAVAID certification. Referenced in Vol 1 DAFGM Att 1 references and A7.1.1.4.', '6 Nov 2016', 'https://www.faa.gov/documentLibrary/media/Order/8200.1D_CHG_1_2_(Final).pdf', 'VII-B', 'Vol. 1', 'lighting', 'FAA', false, false, true, ARRAY['flight inspection', 'RAWS', 'NAVAID certification', '8200.1D']);
